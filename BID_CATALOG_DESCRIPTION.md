...
3. **Planificación del despliegue de recursos humanos y materiales** — cuando un gobierno necesita llevar servicios a la población (transporte escolar, brigadas de vacunación, distribución de alimentos, inspecciones sanitarias), la herramienta calcula la mejor asignación de flota y cuadrillas respetando restricciones reales: cuánto lleva cada vehículo, en qué horarios debe entregar, qué habilidades específicas necesita (como cadena de frío), y desde qué puntos sale. La herramienta puede minimizar costo operativo, no solo distancia o tiempo. Además, soporta operaciones de recogida y entrega vinculada: recoger insumos en un centro de acopio y entregarlos en las comunidades, garantizando que la recogida ocurre antes de la entrega. Permite responder: *"¿cuántas brigadas necesito y qué comunidades atiende cada una para servir 200 comunidades?"*
...
La herramienta se integra a los sistemas existentes del gobierno: recibe los datos de servicios, población y recursos disponibles, y entrega planes de despliegue y diagnósticos de cobertura listos para usar.
