...
3. **Optimización del despliegue de recursos humanos y materiales** — cuando un gobierno necesita desplegar brigadas, vehículos o equipos (transporte escolar, brigadas de vacunación, distribución de alimentos, inspecciones sanitarias), la herramienta calcula la mejor asignación de flota y cuadrillas respetando restricciones reales: cuánto lleva cada vehículo, en qué horarios debe entregar, qué habilidades específicas necesita (como cadena de frío), y desde qué puntos sale. La herramienta puede optimizar por menor costo operativo, no solo por distancia o tiempo. Además, soporta operaciones de recogida y entrega vinculada: recoger insumos en un centro de acopio y entregarlos en las comunidades, garantizando que la recogida ocurre antes de la entrega. Permite responder: *"¿cuántos vehículos y brigadas necesito y qué recorrido hacen para servir 200 comunidades?"*
